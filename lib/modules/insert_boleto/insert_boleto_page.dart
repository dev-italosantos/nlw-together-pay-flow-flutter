...
class _InsertBoletoPageState extends State<InsertBoletoPage> {
  final controller = insertBoleroController();

  final moneyInputController = MoneyMaskedTextController(
    leftSymbol: "R\$",
    decimalSeparator: ",",
  );
  final dueDateInputTextContrller = MaskedTextController(mask: "00/00/0000");
    ...
    return Scaffold(
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    InputTextWidget(
                      controller: dueDateInputTextContrller,
                      label: "Vencimento",
      ...
      bottomNavigationBar: SetLabelButtons(
        ...
        secondaryOnPressed: () async {
          await controller.cadastraBoleto();
          Navigator.pop(context);
        },
      ),
    );
